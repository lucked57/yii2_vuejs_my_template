...
<div class="mb-3">
  <!--<input v-on:change="handleFileUpload" id="file" type="file" name="file" accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,
text/plain, application/pdf">-->
<input type="file" @change="onFileChange" accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,
text/plain, application/pdf">
</div>
  ...
  <button type="submit" id="send_file" v-on:click="Sendemailfile" class="btn btn-primary mt-2 mb-5">Отправить</button>
</form>
</div>
</main>